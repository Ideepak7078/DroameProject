...
.brand-logo {
  height: 100px;
  width: 100px;
  background:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNF9tJgE2FJh2JfMEJwdZ0Vehq6kqhnzNyDtx9EeH3rA&s);
  margin: auto;
  border-radius: 50%;
  box-sizing: border-box;
...
<div class="container">
    ...
    <div class="inputs">
      ...
      <button type="submit">Fetch_customer</button>
